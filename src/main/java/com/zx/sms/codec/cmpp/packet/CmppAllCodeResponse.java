 ...
 *
 */
public enum CmppAllCodeResponse implements PacketStructure {
    ...
    private int length;
    private  int bodyLength =200;

    private CmppAllCodeResponse(DataType dataType, boolean isFixFiledLength, int length) {
